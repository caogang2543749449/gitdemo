...
class Group extends Backend
{
    ...
    public function _initialize()
    {
        ...
        $this->view->assign('typelist', $this->model->getGroupTypeList());
    ...
    public function roletree()
    {
        ...
        if (($pid || $parentGroupModel) && (!$id || $currentGroupModel)) {
            $ptype = $parentGroupModel->getAttr('type');
            $type = null;
            if(!$currentGroupModel) {
                $type = is_null($ptype)?AuthGroup::GROUP_TYPE_PLATFORM:$ptype;
            } else {
                $type = is_null($ptype)?$currentGroupModel->getAttr('type'):$ptype;
            }
            ...
            if (!$id || !in_array($pid, $this->childrenGroupIds) || !in_array($pid, $groupTree->getChildrenIds($id, true))) {
                ...
                $this->success('', null, ["nodelist"=>$nodeList, "type"=>$type]);
            } else {
