...
class Backend extends Controller
{
    ...
    public function _initialize()
    {
        ...
        $this->assign('is_super', $this->auth->isSuperAdmin());
        $this->assignconfig('is_super', $this->auth->isSuperAdmin());
        ...
        $this->assign('is_platform', $isPlatformAdmin);
        $this->assignconfig('is_platform', $isPlatformAdmin);
    }
