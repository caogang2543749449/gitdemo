<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:96:"D:\phpStudy\PHPTutorial\WWW\fastadmin3\public/../application/admin\view\general\regions\add.html";i:1578468175;s:81:"D:\phpStudy\PHPTutorial\WWW\fastadmin3\application\admin\view\layout\default.html";i:1577093820;s:78:"D:\phpStudy\PHPTutorial\WWW\fastadmin3\application\admin\view\common\meta.html";i:1577093820;s:80:"D:\phpStudy\PHPTutorial\WWW\fastadmin3\application\admin\view\common\script.html";i:1577093820;}*/ ?>
<!DOCTYPE html>
...
<script type="text/javascript">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-code" data-rule="required;length(~10)" class="form-control" name="row[code]" type="text">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Prefecture'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-prefecture" data-rule="required;length(~10)" class="form-control" name="row[prefecture]" type="text">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('City'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <div class='control-relative'><input id="c-city" data-rule="length(~15)" class="form-control" name="row[city]" type="text"></div>
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Ward'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-ward" class="form-control" name="row[ward]" data-rule="length(~20)" type="text">
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            ...
            <input  id="c-open_switch" name="row[open_switch]" type="hidden" value="1">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            ...
            <input  id="c-is_popular" name="row[is_popular]" type="hidden" value="1">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-popular_order" class="form-control" name="row[popular_order]" type="number">
        </div>
    </div>
    <div class="form-group">
