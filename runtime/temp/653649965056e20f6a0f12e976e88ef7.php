<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:96:"D:\phpStudy\PHPTutorial\WWW\fastadmin3\public/../application/admin\view\merchant\coupon\add.html";i:1578460867;s:81:"D:\phpStudy\PHPTutorial\WWW\fastadmin3\application\admin\view\layout\default.html";i:1577093820;s:78:"D:\phpStudy\PHPTutorial\WWW\fastadmin3\application\admin\view\common\meta.html";i:1577093820;s:80:"D:\phpStudy\PHPTutorial\WWW\fastadmin3\application\admin\view\common\script.html";i:1577093820;}*/ ?>
<!DOCTYPE html>
...
<script type="text/javascript">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-title" data-rule="required;length(~100)" class="form-control" name="row[title]" type="text">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Store_name'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-store_name" class="form-control" name="row[store_name]" type="text" data-rule="required;length(~100)">
        </div>
    </div>
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <div class="input-group">
                <input id="c-store_logo_image" class="form-control" size="50" data-rule="required;length(~255)" name="row[store_logo_image]" type="text">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-store_address" class="form-control" name="row[store_address]" type="text" data-rule="required;length(~255)">
        </div>
    </div>
    <div class="form-group" id="f-gis_coord">
        ...
        <div class="col-xs-12 col-sm-8">
            <div class="input-group">
                <input id="c-gis_coord" data-rule="required" class="form-control" size="50" name="row[gis_coord]" type="text">
                <div class="input-group-addon no-border no-padding">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            ...
            <input  id="c-get_limit" name="row[get_limit]" type="number" value="0" style="display: none;margin-top: 5px;">
        </div>
    </div>
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            ...
            <select  id="c-get_rule" class="form-control selectpicker" multiple="" name="row[get_rule]">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            ...
            <select  id="c-use_rule" class="form-control selectpicker" name="row[use_rule]">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <select  id="c-valid_switch" data-rule="required" class="form-control selectpicker" name="row[valid_switch][]">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-start_time" data-rule="required" class="form-control datetimepicker" data-date-format="YYYY-MM-DD 00:00:00" data-use-current="true" name="row[start_time]" type="text" value="<?php echo date('Y-m-d H:i:s'); ?>">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('End_time'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-end_time" data-rule="required; match(gt, row[start_time], date)" class="form-control datetimepicker" data-date-format="YYYY-MM-DD 23:59:59" data-use-current="true" name="row[end_time]" type="text" value="<?php echo date('Y-m-d H:i:s'); ?>">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Effe_days'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input  id="c-effe_days" name="row[effe_days]" type="number" value="1" min="1"> <?php echo __('Within Days'); ?>
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <div class="input-group"> 
                <input id="c-qr_image" data-rule="required;length(~255)" class="form-control" size="50" name="row[qr_image]" type="text">
                <div class="input-group-addon no-border no-padding">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-rule" data-rule="required" class="form-control" name="row[rule]" type="text" />
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            ...
            <input  id="c-tax_free_switch" name="row[tax_free_switch]" type="hidden" value="0">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            ...
            <input  id="c-open_switch" name="row[open_switch]" type="hidden" value="0">
