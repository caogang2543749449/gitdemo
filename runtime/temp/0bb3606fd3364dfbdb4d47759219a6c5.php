<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:91:"D:\phpStudy\PHPTutorial\WWW\fastadmin3\public/../application/admin\view\user\user\edit.html";i:1578462815;s:81:"D:\phpStudy\PHPTutorial\WWW\fastadmin3\application\admin\view\layout\default.html";i:1577093820;s:78:"D:\phpStudy\PHPTutorial\WWW\fastadmin3\application\admin\view\common\meta.html";i:1577093820;s:80:"D:\phpStudy\PHPTutorial\WWW\fastadmin3\application\admin\view\common\script.html";i:1577093820;}*/ ?>
<!DOCTYPE html>
...
<script type="text/javascript">
    ...
    <div class="form-group">
        <label for="c-username" class="control-label col-xs-12 col-sm-2 required"><?php echo __('Username'); ?>:</label>
        <div class="col-xs-12 col-sm-4">
            <input id="c-username" data-rule="required;length(~32)" class="form-control" name="row[username]" type="text" value="<?php echo htmlentities($row['username']); ?>">
        </div>
    </div>
    <div class="form-group">
        <label for="c-nickname" class="control-label col-xs-12 col-sm-2 required"><?php echo __('Nickname'); ?>:</label>
        <div class="col-xs-12 col-sm-4">
            <input id="c-nickname" data-rule="required;length(~50)" class="form-control" name="row[nickname]" type="text" value="<?php echo htmlentities($row['nickname']); ?>">
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-4">
            <input id="c-mobile" data-rule="mobile;length(~11)" class="form-control" name="row[mobile]" type="text" value="<?php echo htmlentities($row['mobile']); ?>">
        </div>
    </div>
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <div class="input-group">
                <input id="c-avatar" data-rule="length(~255)" class="form-control" size="50" name="row[avatar]" type="text" value="<?php echo $row['avatar']; ?>">
    ...
    <div class="form-group">
        <label for="c-level" class="control-label col-xs-12 col-sm-2 required"><?php echo __('Level'); ?>:</label>
        <div class="col-xs-12 col-sm-4">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-bio" data-rule="length(~100)" class="form-control" name="row[bio]" type="text" value="<?php echo htmlentities($row['bio']); ?>">
        </div>
    </div>
    <div class="form-group">
        <label for="c-money" class="control-label col-xs-12 col-sm-2 required"><?php echo __('Money'); ?>:</label>
        <div class="col-xs-12 col-sm-4">
            <input id="c-money" data-rule="required" class="form-control" name="row[money]" type="number" value="<?php echo $row['money']; ?>">
        </div>
    </div>
    <div class="form-group">
        <label for="c-score" class="control-label col-xs-12 col-sm-2 required"><?php echo __('Score'); ?>:</label>
        <div class="col-xs-12 col-sm-4">
            <input id="c-score" data-rule="required" class="form-control" name="row[score]" type="number" value="<?php echo $row['score']; ?>">
        </div>
    </div>
    <div class="form-group">
        <label for="c-successions" class="control-label col-xs-12 col-sm-2 required"><?php echo __('Successions'); ?>:</label>
        <div class="col-xs-12 col-sm-4">
    ...
    <div class="form-group">
        <label for="c-maxsuccessions" class="control-label col-xs-12 col-sm-2 required"><?php echo __('Maxsuccessions'); ?>:</label>
        <div class="col-xs-12 col-sm-4">
    ...
    <div class="form-group">
        <label for="c-prevtime" class="control-label col-xs-12 col-sm-2 required"><?php echo __('Prevtime'); ?>:</label>
        <div class="col-xs-12 col-sm-4">
    ...
    <div class="form-group">
        <label for="c-logintime" class="control-label col-xs-12 col-sm-2 required"><?php echo __('Logintime'); ?>:</label>
        <div class="col-xs-12 col-sm-4">
    ...
    <div class="form-group">
        <label for="c-loginip" class="control-label col-xs-12 col-sm-2 required"><?php echo __('Loginip'); ?>:</label>
        <div class="col-xs-12 col-sm-4">
            <input id="c-loginip" data-rule="required,length(~50)" class="form-control" name="row[loginip]" type="text" value="<?php echo $row['loginip']; ?>">
        </div>
    </div>
    <div class="form-group">
        <label for="c-loginfailure" class="control-label col-xs-12 col-sm-2 required"><?php echo __('Loginfailure'); ?>:</label>
        <div class="col-xs-12 col-sm-4">
    ...
    <div class="form-group">
        <label for="c-joinip" class="control-label col-xs-12 col-sm-2 required"><?php echo __('Joinip'); ?>:</label>
        <div class="col-xs-12 col-sm-4">
