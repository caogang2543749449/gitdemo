<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:94:"D:\phpStudy\PHPTutorial\WWW\fastadmin3\public/../application/admin\view\service\goods\add.html";i:1578532659;s:81:"D:\phpStudy\PHPTutorial\WWW\fastadmin3\application\admin\view\layout\default.html";i:1577093820;s:78:"D:\phpStudy\PHPTutorial\WWW\fastadmin3\application\admin\view\common\meta.html";i:1577093820;s:80:"D:\phpStudy\PHPTutorial\WWW\fastadmin3\application\admin\view\common\script.html";i:1577093820;}*/ ?>
<!DOCTYPE html>
...
<script type="text/javascript">
    ...
    <input id="c-merchant_id" name="row[merchant_id]" type="hidden" value="<?php echo $merchant['id']; ?>">
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2 required"><?php echo __('Name'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-name" data-rule="required;length(~100)" class="form-control" name="row[name]" type="text">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2 required"><?php echo __('Local name'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-local-name" data-rule="required;length(~200)" class="form-control" name="row[local_name]" type="text">
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <div class="input-group">
                <input id="c-thumb_image" class="form-control" data-rule="required;length(~255)" size="50" name="row[thumb_image]" type="text">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <div class="input-group">
                <input id="c-desc_images" class="form-control" size="50" data-rule="required;length(~4000)" name="row[desc_images]" type="text">
                <div class="input-group-addon no-border no-padding">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-goods_sn" class="form-control" name="row[goods_sn]" type="text" data-rule="required;length(~64)">
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <select id="c-quota" class="form-control selectpicker" name="row[quota]">
                <?php $__FOR_START_1378430431__=0;$__FOR_END_1378430431__=11;for($i=$__FOR_START_1378430431__;$i < $__FOR_END_1378430431__;$i+=1){ ?>
                <option value="<?php echo $i; ?>" <?php if($i==0): ?>selected<?php endif; ?>><?php if($i==0): ?><?php echo __('No limit'); else: ?><?php echo $i; endif; ?></option>
                <?php } ?>
            </select>
        </div>
    </div>
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-original_price" class="form-control" name="row[original_price]" type="number">
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <textarea id="c-brief" class="form-control " rows="5" name="row[brief]" cols="50" maxlength="300"></textarea>
        </div>
    </div>
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            ...
            <input  id="c-is_hot" name="row[is_hot]" type="hidden" value="0">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <?php echo build_radios('row[is_for_sale]', ['0'=>__('Not For Sale'), '1'=>__('For Sale')], 0); ?>
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Labels'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-labels" class="form-control" data-rule="length(~255)" name="row[labels]" type="text">
        </div>
    </div>
    <div class="form-group">
        ...
        <input id="c-attributes" name="row[attributes]" type="hidden">
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Description'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <textarea id="c-description" class="form-control summernote" name="row[description]" cols="50"></textarea>
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Notice'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <textarea id="c-Notice"   class="form-control summernote" data-height="250" data-onlytext="true" data-maxlength="1000" name="row[notice]" cols="50"></textarea>
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group layer-footer">
        ...
        <div class="col-xs-12 col-sm-1">
            <button type="button" class="btn btn-danger btn-embossed btn-close"><?php echo __('Close'); ?></button>
        </div>
    </div>
</form>
