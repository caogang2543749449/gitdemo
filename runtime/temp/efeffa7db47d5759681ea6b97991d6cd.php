<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:98:"D:\phpStudy\PHPTutorial\WWW\fastadmin3\public/../application/admin\view\general\profile\index.html";i:1577093820;s:81:"D:\phpStudy\PHPTutorial\WWW\fastadmin3\application\admin\view\layout\default.html";i:1577093820;s:78:"D:\phpStudy\PHPTutorial\WWW\fastadmin3\application\admin\view\common\meta.html";i:1577093820;s:80:"D:\phpStudy\PHPTutorial\WWW\fastadmin3\application\admin\view\common\script.html";i:1577093820;}*/ ?>
<!DOCTYPE html>
            ...
            <div class="panel-body">
                ...
                <form id="update-form" role="form" data-toggle="validator" method="POST" action="<?php echo url('general/profile/update'); ?>">
                    ...
                    <div class="box-body box-profile">
                        ...
                        <div class="form-group">
                            <label for="email" class="control-label required"><?php echo __('Email'); ?>:</label>
                        ...
                        <div class="form-group">
                            <label for="nickname" class="control-label required"><?php echo __('Nickname'); ?>:</label>
