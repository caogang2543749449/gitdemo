<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:90:"D:\phpStudy\PHPTutorial\WWW\fastadmin3\public/../application/admin\view\category\edit.html";i:1578465957;s:81:"D:\phpStudy\PHPTutorial\WWW\fastadmin3\application\admin\view\layout\default.html";i:1577093820;s:78:"D:\phpStudy\PHPTutorial\WWW\fastadmin3\application\admin\view\common\meta.html";i:1577093820;s:80:"D:\phpStudy\PHPTutorial\WWW\fastadmin3\application\admin\view\common\script.html";i:1577093820;}*/ ?>
<!DOCTYPE html>
...
<script type="text/javascript">
    ...
    <div class="form-group">
        <label for="c-type" class="control-label col-xs-12 col-sm-2 required"><?php echo __('Type'); ?>:</label>
    ...
    <div class="form-group">
        <label for="c-pid" class="control-label col-xs-12 col-sm-2 required"><?php echo __('Pid'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
    ...
    <div class="form-group">
        <label for="c-name" class="control-label col-xs-12 col-sm-2 required"><?php echo __('Name'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <div class="input-group">
                <input id="c-image" class="form-control" size="35" data-rule="length(~100)" name="row[image]" type="text" value="<?php echo $row['image']; ?>">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-keywords" class="form-control"  data-rule="length(~255)" name="row[keywords]" type="text" value="<?php echo htmlentities($row['keywords']); ?>">
        </div>
    </div>
    <div class="form-group">
        <label for="c-description" class="control-label col-xs-12 col-sm-2"><?php echo __('Description'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <textarea id="c-description" class="form-control" data-rule="length(~255)" name="row[description]"><?php echo htmlentities($row['description']); ?></textarea>
        </div>
    </div>
    <div class="form-group">
