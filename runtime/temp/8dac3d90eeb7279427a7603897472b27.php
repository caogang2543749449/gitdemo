<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:104:"D:\phpStudy\PHPTutorial\WWW\fastadmin3\public/../application/admin\view\merchant\merchant_prop\edit.html";i:1578477254;s:81:"D:\phpStudy\PHPTutorial\WWW\fastadmin3\application\admin\view\layout\default.html";i:1577093820;s:78:"D:\phpStudy\PHPTutorial\WWW\fastadmin3\application\admin\view\common\meta.html";i:1577093820;s:80:"D:\phpStudy\PHPTutorial\WWW\fastadmin3\application\admin\view\common\script.html";i:1577093820;}*/ ?>
<!DOCTYPE html>
...
<script type="text/javascript">
    ...
    <div class="panel-heading">
        <ul class="nav nav-tabs ">
            <li class="active"><a href="#" data-value="" data-toggle="tab"><?php echo __('Merchant Properties'); ?></a></li>
        </ul>
    </div>
    ...
    <div class="panel-body">
        <form id="edit-form" class="form-horizontal" role="form" data-toggle="validator" method="POST" action="">
            ...
            <div class="form-group">
                ...
                <div class="col-xs-12 col-sm-8">
                    <input id="c-url" class="form-control"   name="row[MerchantProperties][url]" type="text" value="<?php echo htmlentities($row['MerchantProperties']['url']); ?>" data-rule="url;length(~255)">
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-xs-12 col-sm-8">
                    <div class="input-group">
                        <input id="c-descimages" class="form-control" data-rule="length(~4000)" size="50" name="row[MerchantProperties][descimages]" type="text" value="<?php echo htmlentities($row['MerchantProperties']['descimages']); ?>">
                        <div class="input-group-addon no-border no-padding">
            ...
            <div class="form-group">
                ...
                <div class="col-xs-12 col-sm-8">
                    <input id="c-tel" class="form-control" name="row[MerchantProperties][tel]" type="text" value="<?php echo htmlentities($row['MerchantProperties']['tel']); ?>" data-rule="tel;length(~20)">
                </div>
            </div>
            <div class="form-group">
                <label class="control-label col-xs-12 col-sm-2"><?php echo __('MerchantProperties.Fax'); ?>:</label>
                <div class="col-xs-12 col-sm-8">
                    <input id="c-fax" class="form-control" name="row[MerchantProperties][fax]" type="text" value="<?php echo htmlentities($row['MerchantProperties']['fax']); ?>" data-rule="tel;length(~20)">
                </div>
            </div>
            <div class="form-group">
                <label class="control-label col-xs-12 col-sm-2"><?php echo __('MerchantProperties.Email'); ?>:</label>
                <div class="col-xs-12 col-sm-8">
                    <input id="c-email" class="form-control" name="row[MerchantProperties][email]" type="text" value="<?php echo htmlentities($row['MerchantProperties']['email']); ?>" data-rule="email;length(~100)">
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-xs-12 col-sm-8">
                    <div class="input-group">
                        <input id="c-postcode" class="form-control" name="row[MerchantProperties][postcode]" type="text" value="<?php echo htmlentities($row['MerchantProperties']['postcode']); ?>" data-rule="digits;length(~7)" data-target=".postcode">
            ...
            <div class="form-group">
                ...
                <div class="col-xs-12 col-sm-8">
                    <input id="c-address1" class="form-control" data-rule="length(~100)" name="row[MerchantProperties][address1]" type="text" value="<?php echo htmlentities($row['MerchantProperties']['address1']); ?>">
                </div>
            </div>
            <div class="form-group">
                <label class="control-label col-xs-12 col-sm-2"><?php echo __('MerchantProperties.Address2'); ?>:</label>
                <div class="col-xs-12 col-sm-8">
                    <input id="c-address2" class="form-control" data-rule="length(~100)" name="row[MerchantProperties][address2]" type="text" value="<?php echo htmlentities($row['MerchantProperties']['address2']); ?>">
                </div>
            </div>
            <div class="form-group">
                <label class="control-label col-xs-12 col-sm-2"><?php echo __('MerchantProperties.Address3'); ?>:</label>
                <div class="col-xs-12 col-sm-8">
                    <input id="c-address3" class="form-control" data-rule="length(~100)" name="row[MerchantProperties][address3]" type="text" value="<?php echo htmlentities($row['MerchantProperties']['address3']); ?>">
                </div>
            </div>
            <div class="form-group">
                <label class="control-label col-xs-12 col-sm-2"><?php echo __('MerchantProperties.Address4'); ?>:</label>
                <div class="col-xs-12 col-sm-8">
                    <input id="c-address4" class="form-control" data-rule="length(~100)" name="row[MerchantProperties][address4]" type="text" value="<?php echo htmlentities($row['MerchantProperties']['address4']); ?>">
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-xs-12 col-sm-8">
                    <div class="input-group">
                        <input id="c-gis_coord" class="form-control"  data-rule="length(~50)" name="row[MerchantProperties][gis_coord]" type="text" value="<?php echo htmlentities($row['MerchantProperties']['gis_coord']); ?>">
                        <div class="input-group-addon no-border no-padding">
            ...
            <div class="form-group layer-footer">
                ...
                <div class="col-xs-12 col-sm-6">
                    <button type="button" class="btn btn-info btn-embossed btn-cancel"><?php echo __('Cancel'); ?></button>
                </div>
            </div>
